...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="my_account.php"><i class="fa-solid fa-blog"></i> Posts</a>
                  </li>
                  <li class="nav-item">
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col form-div">
        <div class="reviews">
                    <h4 class="alignleft"><b>My Posts</b></h4>
                    <?php
                

                     $sql = "SELECT * FROM `posts` WHERE `users`='$username'";
     ...
     <div class="card-content">
       <div class="img-place">
          <div id="card-img"><img src="posts-images/<?php echo $image_post; ?>"></div>
       </div>
       <div class="card-text">
       <?php 
         ...
         ?>
         <p><?php echo $post ?></p>
         <a href="delete-post.php?id=<?php echo $id?>"><button class="btn"><i class="fa-solid fa-trash"></i></button></a>
                         ...
                         <?php 
                          ...
                          echo "Momentan nu ai creat nici o postare.";
                        }
