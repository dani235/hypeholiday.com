...
<html>
    <head>
        <!--Title-->
        <title>Forgot Password? - Hype Holiday</title>
        <!--IMG-->
    ...
    <body>
      ...
      <main class="main">
         ...
         <form method="POST" action="get_code.php" class="login">
          ...
          <?php endif; ?>
           ...
           <div class="group">
             <a href="#"  onclick="history.back()">Get Back</a>
           </div>
           <button type="submit" class="btn" name="fpsw">Send Now</button>
             <div class="groupRow">
